...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports r_in]
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports btnT]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports s_in]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports e]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports e]
